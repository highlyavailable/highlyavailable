...
Welcome to my profile! I recently graduated from UW-Madison with a BS in Computer Science and Data Science (Spring '23); since then I have moved to Minneapolis, MN and am joining U.S. Bank as an entry-level SWE and am joining Georgia Tech's [OMSCS]([url](https://omscs.gatech.edu/)) program this Summer!🖥️ Thanks for visiting and feel free to [connect](https://www.linkedin.com/in/peter-bryant-33b7091b6/) or send me an [email](mailto:pwbryant1@gmail.com).
